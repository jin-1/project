		...
		<div id="container">
			...
			<table class="m_table">
				...
				<tr>
					...
					<td class="con_input"><input class="content" type="text"size="100px" value="<%=noticeDto.getNoticeTitle()%>" disabled="disabled"/>
				</tr>
				<tr>
					<td class="tent_label"><span style="color: red">*</span> 공지내용</td>
					<td class="tent_input"><textarea class="tent" disabled="disabled"><%=noticeDto.getNoticeContent()%>
					</textarea>
				</tr>
			</table>
			</form:form>
			<div class="bottom">
				<p class="notice_details">목 록</p>
			</div>
		</div>
	</div>
