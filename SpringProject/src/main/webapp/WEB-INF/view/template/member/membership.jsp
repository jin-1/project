					...
					<table class="m_table">
						...
						<tr>
							...
							<td class="m_idcheck"><input type="text" class="m_id"
								maxlength="15" size="20" name="memberId" />&nbsp; <span
								id="idcheck"></span><br />
						...
						<tr>
							...
							<td><label><input type="radio" name="gender"
									value="남성" checked /> 남성</label> <label><input type="radio"
									name="gender" value="여성" /> 여성</label></td>
						...
						<tr>
							...
							<td class="tour">관광지 &nbsp;&nbsp;&nbsp;&nbsp; <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="레저" />레저</label>
								<label><input type="checkbox" class="m_inter"
									name="mem_ints" value="스포츠" />스포츠</label> <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="역사" />역사
							</label> <label><input type="checkbox" class="m_inter"
									name="mem_ints" value="축제" />축제</label>
						...
						<tr>
							...
							<td>맛&nbsp;&nbsp;&nbsp;집&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="한식" />한식</label>
								<label><input type="checkbox" class="m_inter"
									name="mem_ints" value="일식" />일식</label> <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="중식" />중식
							</label> <label><input type="checkbox" class="m_inter"
									name="mem_ints" value="양식" />양식</label>
						...
						<tr>
							...
							<td>숙&nbsp;&nbsp;&nbsp;박&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="호텔" />호텔</label>
								<label><input type="checkbox" class="m_inter"
									name="mem_ints" value="모텔" />모텔</label> <label><input
									type="checkbox" class="m_inter" name="mem_ints" value="찜질방" />찜질방</label>
								<label><input type="checkbox" class="m_inter"
									name="mem_ints" value="게스트하우스" />게스트하우스</label> <br />
