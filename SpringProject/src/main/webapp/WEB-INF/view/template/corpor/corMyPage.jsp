...
<%
	...
	String memberId = memberdto.getCorporId();
	String memberPw = memberdto.getCorporPw();
	String memberName = memberdto.getCorporName();
	String memberPhone = memberdto.getCorporPhone();
	String memberMail = memberdto.getCorporEmail();
	String memberPost = memberdto.getCorporAddr();
...
<body>
	...
	<div id="mid">
		<div id="container">
			<h2>내정보수정</h2>
			<hr />
			<form:form id="myPageFrm" modelAttribute="corporPage">
				<div id="form">
					<table class="m_table">
						<colgroup>
						...
						<tr>
							<td>ID</td>
							<td class="m_idcheck">
							<input type="text" class="MyPage_id" maxlength="15" size="20" value="<%=memberId%>" name="corporId" />&nbsp;
								<br />
						...
						<tr>
							...
							<td><br /> <input type="password" class="myPage_pw"
								size="15" value="<%=memberPw%>" name="corporPw" /><br />
						...
						<tr>
							...
							<td><input type="text" class="myPage_name" maxlength="10"
								value="<%=memberName%>" size="10" name="corporName" /></td>
						...
						<tr>
							...
							<input type="hidden" class="myPage_phone4" name="corporPhone" /></td>
						</tr>
						<tr>
							<td>이메일</td>
							...
							</select> <input type="hidden" class="myPage_mail4" name="corporEmail" />
							</td>
						</tr>
						<tr>
							<td>주소</td>
							<td class="addrIn"><input type="text" maxlength="5" size="8"
								...
								id="myPage_post4" name="corporAddr" /></td>
