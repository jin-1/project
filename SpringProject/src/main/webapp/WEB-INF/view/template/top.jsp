	...
	<div id="header">
		...
		<div id="menu">
			<ul>
				...
				<li id="RENT"><a href="SearchProduct?menu=RENT&img=rentWallpaper">RENT</a></li>
			...
			<div id="submenu">
				<ul id=trainSub>
					<li id="trainInfo"><a href="TrainInfoKTX?menu=TRAIN&img=trainbg">기차역
							정보</a></li>
					<li id="trainTicket"><a
	...
	<div id="headerSub">
		...
		<div id="menuSub">
			<ul>
				...
				<li id="RENT"><a href="SearchProduct?menu=RENT&img=rentWallpaper">RENT</a></li>
				<li id="TRAINSub"><a href="TrainInfoKTX.jsp?menu=TRAIN&img=trainbg">TRAIN</a></li>
