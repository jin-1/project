...
<body>
   ...
   <div id="mid">
      ...
      <div id="btnArea">
         ...
         <button class="btnInsert" id="btnInsert" onclick="javascript:sendPrd();">등록</button>
         <button class="btnCart" id="btnCart" onclick="window.history.back(); return false;">취소</button> 
      </div>
   </div>
    </form>
   <div id="bot">
