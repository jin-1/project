...
<%
	...
	String point = String.valueOf(request.getAttribute("point"));
%>
		...
		<div class="section3" align="center">
			<div class="content content3">
				...
				<div class="vsMenupan">
					<h1 id="win">승리 :</h1>
					<ul class="rps">
						<li style="display:;" id="rps1"><img
							src="./img/rps_basic.gif"></li>
						<li style="display: none;" id="rps2"><img id="img1"
							src="./img/rps_all.gif"></li>
						<li style="display: none;" id="Com0"><img
							src="./img/rps_scissors.gif" alt="가위"></li>
						<li style="display: none;" id="Com1"><img
							src="./img/rps_rock.gif" alt="바위"></li>
						<li style="display: none;" id="Com2"><img
							src="./img/rps_paper.gif" alt="보"></li>
					</ul>
				</div>
				<form name="form" id="form">
					...
					<div class="vsMine">
						<ul class="rps">
							<li style="display:;" id="user1"><img
								src="./img/rps_basic.gif"></li>
							<li style="display: none;" id="user2"><img
								src="./img/rps_scissors.gif" alt="가위"></li>
							<li style="display: none;" id="user3"><img
								src="./img/rps_rock.gif" alt="바위"></li>
							<li style="display: none;" id="user4"><img
								src="./img/rps_paper.gif" alt="보"></li>
						</ul>
						<ul class="btnRps">
							<li><a href="javascript:;"
								onclick="javascript:UserClick(2);"><img
									src="./img/btn_scissors.gif" alt="가위"></a></li>
							<li><a href="javascript:;"
								onclick="javascript:UserClick(3);"><img
									src="./img/btn_rock.gif" alt="바위"></a></li>
							<li><a href="javascript:;"
								onclick="javascript:UserClick(4);"><img
									src="./img/btn_paper.gif" alt="보"></a></li>
						</ul>

					</div>
					<p class="btnVs">
						<a href="javascript:;" onclick="javascript:T();"><img
							src="./img/btn_vs.gif"></a>
					</p>
